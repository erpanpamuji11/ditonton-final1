...
import 'package:ditonton/domain/entities/tv_series/tvseries.dart' as _i10;
import 'package:ditonton/domain/entities/tv_series/tvseries_detail.dart' as _i7;
import 'package:ditonton/domain/usecases/tv_series/get_tvseries_detail.dart' as _i2;
import 'package:ditonton/domain/usecases/tv_series/get_tvseries_recommendations.dart' as _i3;
import 'package:ditonton/domain/usecases/tv_series/get_watchlist_tvseries_status.dart'
as _i4;
import 'package:ditonton/domain/usecases/tv_series/remove_tvseries_watchlist.dart' as _i6;
import 'package:ditonton/domain/usecases/tv_series/save_tvseries_watchlist.dart' as _i5;
...
class _FakeGetTvDetail_0 extends _i1.Fake implements _i2.GetTvSeriesDetail {}
...
class _FakeSaveWatchlistTv_3 extends _i1.Fake implements _i5.SaveWatchlistTvSeries {}

class _FakeRemoveWatchlistTv_4 extends _i1.Fake
    implements _i6.RemoveWatchlistTvSeries {}

class _FakeTvDetail_5 extends _i1.Fake implements _i7.TvSeriesDetail {}

/// A class which mocks [TvDetailNotifier].
///
/// See the documentation for Mockito's code generation for more information.
class MockTvDetailNotifier extends _i1.Mock implements _i8.TvSeriesDetailNotifier {
  ...
  _i2.GetTvSeriesDetail get getTvDetail =>
      (super.noSuchMethod(Invocation.getter(#getTvDetail),
          returnValue: _FakeGetTvDetail_0()) as _i2.GetTvSeriesDetail);
  _i3.GetTvSeriesRecommendations get getTvRecommendations => (super.noSuchMethod(
      Invocation.getter(#getTvRecommendations),
      returnValue: _FakeGetTvRecommendations_1()) as _i3.GetTvSeriesRecommendations);
  _i4.GetWatchListStatusTvSeries get getWatchListStatusTv => (super.noSuchMethod(
      Invocation.getter(#getWatchListStatusTv),
      returnValue: _FakeGetWatchListStatusTv_2()) as _i4.GetWatchListStatusTvSeries);
  _i5.SaveWatchlistTvSeries get saveWatchlistTv =>
      (super.noSuchMethod(Invocation.getter(#saveWatchlistTv),
          returnValue: _FakeSaveWatchlistTv_3()) as _i5.SaveWatchlistTvSeries);
  _i6.RemoveWatchlistTvSeries get removeWatchlistTv =>
      (super.noSuchMethod(Invocation.getter(#removeWatchlistTv),
          returnValue: _FakeRemoveWatchlistTv_4()) as _i6.RemoveWatchlistTvSeries);
  @override
  _i7.TvSeriesDetail get tv => (super.noSuchMethod(Invocation.getter(#tv),
      returnValue: _FakeTvDetail_5()) as _i7.TvSeriesDetail);
  ...
  @override
  _i11.Future<void> addWatchlistTv(_i7.TvSeriesDetail? tv) => (super.noSuchMethod(
