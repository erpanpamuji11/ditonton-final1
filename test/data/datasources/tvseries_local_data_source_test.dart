...
void main() {
  ...
  setUp(() {
    ...
    dataSourcetv = TvSeriesLocalDataSourceImpl(databaseHelper: mockDatabaseHelperTv);
  });
  ...
  group('save watchlist tv_series', () {
    test('should return success message when insert to database is success',
      ...
      // act
      final result = await dataSourcetv.insertWatchlistTvSeries(testTvSeriesTable);
      // assert
    ...
    test('should throw DatabaseException when insert tv_series to database is failed',
      ...
      when(mockDatabaseHelperTv.insertWatchlistTvSeries(testTvSeriesTable))
          .thenThrow(Exception());
      // act
      final call = dataSourcetv.insertWatchlistTvSeries(testTvSeriesTable);
      // assert
  ...
  group('remove watchlist tv_series', () {
    ...
    test('should throw DatabaseException when remove tv_series from database is failed',
      ...
      when(mockDatabaseHelperTv.removeWatchlistTvSeries(testTvSeriesTable))
          .thenThrow(Exception());
      // act
      final call = dataSourcetv.removeWatchlistTvSeries(testTvSeriesTable);
      // assert
      expect(() => call, throwsA(isA<DatabaseException>()));
    });
  });
  ...
  group('Get Tv Detail By Id', () {
    ...
    test('should return Tv Detail Table when data is found', () async {
      ...
      // act
      final result = await dataSourcetv.getMovieByIdTvSeries(tId);
      // assert
